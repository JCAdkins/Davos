const UpcomingEvents = () => {
  return (
    <svg
      ...
      x="0px"
      y="0px"
      className="w-8 h-8 text-app_accent-900"
    >
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M7 2C7.55228 2 8 2.44772 8 3V4H16V3C16 2.44772 16.4477 2 17 2C17.5523 2 18 2.44772 18 3V4H19C20.6569 4 22 5.34315 22 7V14C22 14.5523 21.5523 15 21 15C20.4477 15 20 14.5523 20 14V10H4V19C4 19.5523 4.44772 20 5 20H10C10.5523 20 11 20.4477 11 21C11 21.5523 10.5523 22 10 22H5C3.34315 22 2 20.6569 2 19V7C2 5.34315 3.34315 4 5 4H6L6 3C6 2.44772 6.44772 2 7 2ZM5 6C4.44772 6 4 6.44772 4 7V8H20V7C20 6.44772 19.5523 6 19 6H5Z"
        fill="currentColor"
      />
      <path
