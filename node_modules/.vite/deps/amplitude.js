...
// node_modules/amplitude/dist/types.js
var require_types = __commonJS({
  "node_modules/amplitude/dist/types.js"(exports) {
    "use strict";
...
// node_modules/amplitude/dist/errors.js
var require_errors = __commonJS({
  "node_modules/amplitude/dist/errors.js"(exports) {
    "use strict";
    ...
    var AmplitudeErrorResponse = class extends Error {
      constructor(err) {
        super(err.message);
    ...
    var axiosErrorCatcher = (reqPromise) => __awaiter(void 0, void 0, void 0, function* () {
      try {
...
// node_modules/amplitude/package.json
var require_package = __commonJS({
  "node_modules/amplitude/package.json"(exports, module) {
    module.exports = {
      name: "amplitude",
      version: "6.0.0",
...
// node_modules/amplitude/dist/amplitude.js
var require_amplitude = __commonJS({
  "node_modules/amplitude/dist/amplitude.js"(exports) {
    "use strict";
    var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    axios_1.default.defaults.headers.common["User-Agent"] = `amplitude/${// eslint-disable-next-line @typescript-eslint/no-var-requires
    require_package().version} node/${process.version} (${process.arch})`;
    var camelCaseToSnakeCasePropertyMap = {
      userId: "user_id",
      deviceId: "device_id",
    ...
    var Amplitude = class {
      constructor(token, options = {}) {
        ...
        this.token = token;
        this.tokenEndpoint = options.tokenEndpoint || process.env.AMPLITUDE_TOKEN_ENDPOINT || AMPLITUDE_TOKEN_ENDPOINT;
      ...
      identify(data) {
        ...
        return (0, errors_1.axiosErrorCatcher)(axios_1.default.post(`${this.tokenEndpoint}/identify`, encodedParams, {
          headers: {
            "content-type": "application/x-www-form-urlencoded"
          }
        }).then((res) => res.data));
      ...
      track(data, options) {
        ...
        return (0, errors_1.axiosErrorCatcher)(axios_1.default.post(`${this.tokenEndpoint}/2/httpapi`, params).then((res) => res.data));
      }
      export(options) {
      ...
      userSearch(userSearchId) {
        ...
        return (0, errors_1.axiosErrorCatcher)(axios_1.default.get(`${AMPLITUDE_DASHBOARD_ENDPOINT}/usersearch`, {
          auth: {
            username: this.token,
            password: this.secretKey
          },
      ...
      userActivity(amplitudeId, params) {
        ...
        return (0, errors_1.axiosErrorCatcher)(axios_1.default.get(`${AMPLITUDE_DASHBOARD_ENDPOINT}/useractivity`, {
          auth: {
            username: this.token,
            password: this.secretKey
          },
      ...
      eventSegmentation(params) {
        ...
        return (0, errors_1.axiosErrorCatcher)(axios_1.default.get(`${AMPLITUDE_DASHBOARD_ENDPOINT}/events/segmentation`, {
          auth: {
            username: this.token,
            password: this.secretKey
          },
...
// node_modules/amplitude/dist/public.js
var require_public = __commonJS({
  "node_modules/amplitude/dist/public.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/amplitude/dist/responses.js
var require_responses = __commonJS({
  "node_modules/amplitude/dist/responses.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/amplitude/dist/index.js
var require_dist = __commonJS({
  "node_modules/amplitude/dist/index.js"(exports) {
    "use strict";
    ...
    require_types();
    var amplitude_1 = __importDefault(require_amplitude());
    exports.default = amplitude_1.default;
    __exportStar(require_public(), exports);
    __exportStar(require_responses(), exports);
    var errors_1 = require_errors();
    Object.defineProperty(exports, "AmplitudeErrorResponse", { enumerable: true, get: function() {
      return errors_1.AmplitudeErrorResponse;
    } });
  }
});

// node_modules/amplitude/entry.js
var require_entry = __commonJS({
  "node_modules/amplitude/entry.js"(exports, module) {
    var Amplitude = require_dist().default;
