...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/tw-join.mjs
function twJoin() {
  var index3 = 0;
  var argument;
  var resolvedValue;
...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/class-utils.mjs
...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/lru-cache.mjs
...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/modifier-utils.mjs
...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/config-utils.mjs
...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/merge-classlist.mjs
...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/create-tailwind-merge.mjs
...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/from-theme.mjs
...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/validators.mjs
...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/default-config.mjs
...
// node_modules/flowbite-react/node_modules/tailwind-merge/dist/lib/tw-merge.mjs
...
var BreadcrumbItem = (0, import_react9.forwardRef)(({ children, className, href, icon: Icon, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime14.jsxs)("li", { className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime14.jsx)(HiOutlineChevronRight, { "aria-hidden": true, className: theme2.chevron, "data-testid": "flowbite-breadcrumb-separator" }), (0, import_jsx_runtime14.jsxs)(Component, { ref, className: theme2.href[isLink ? "on" : "off"], "data-testid": "flowbite-breadcrumb-item", href, children: [Icon && (0, import_jsx_runtime14.jsx)(Icon, { "aria-hidden": true, className: theme2.icon }), children] })] });
});
...
var BreadcrumbComponent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime15.jsx)("nav", { "aria-label": "Breadcrumb", className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime15.jsx)("ol", { className: theme2.list, children }) });
};
...
var Card = (props) => {
  ...
  return (0, import_jsx_runtime16.jsxs)(Component, { "data-testid": "flowbite-card", href, className: twMerge(theme2.root.base, theme2.root.horizontal[horizontal ? "on" : "off"], href && theme2.root.href, className), ...theirProps, children: [(0, import_jsx_runtime16.jsx)(Image, { ...props }), (0, import_jsx_runtime16.jsx)("div", { className: theme2.root.children, children })] });
};
var Image = ({ theme: customTheme = {}, ...props }) => {
  ...
  if (props.imgSrc) {
    return (0, import_jsx_runtime16.jsx)("img", { "data-testid": "flowbite-card-image", alt: props.imgAlt ?? "", src: props.imgSrc, className: twMerge(theme2.img.base, theme2.img.horizontal[props.horizontal ? "on" : "off"]) });
  }
  return null;
};
...
var Checkbox = (0, import_react12.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime18.jsx)("input", { ref, type: "checkbox", className: twMerge(theme2.root.base, className), ...props });
});
...
var DarkThemeToggle = ({ className, theme: customTheme = {}, iconDark: IconDark = HiSun, iconLight: IconLight = HiMoon, ...props }) => {
  ...
  return (0, import_jsx_runtime19.jsx)("button", { "aria-label": "Toggle dark mode", "data-testid": "dark-theme-toggle", onClick: toggleMode, type: "button", className: twMerge(theme2.root.base, className), ...props, children: mode === "dark" ? (0, import_jsx_runtime19.jsx)(IconLight, { "aria-label": "Currently dark mode", className: theme2.root.icon }) : (0, import_jsx_runtime19.jsx)(IconDark, { "aria-label": "Currently light mode", className: theme2.root.icon }) });
};
...
var DatepickerContext = (0, import_react13.createContext)(void 0);
function useDatePickerContext() {
  const context = (0, import_react13.useContext)(DatepickerContext);
  if (!context) {
...
var DatepickerViewsDays = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [(0, import_jsx_runtime20.jsx)("div", { className: theme2.header.base, children: weekDays.map((day, index3) => (0, import_jsx_runtime20.jsx)("span", { className: theme2.header.title, children: day }, index3)) }), (0, import_jsx_runtime20.jsx)("div", { className: theme2.items.base, children: [...Array(42)].map((_date, index3) => {
    ...
    return (0, import_jsx_runtime20.jsx)("button", { disabled: isDisabled, type: "button", className: twMerge(theme2.items.item.base, isSelected && theme2.items.item.selected, isDisabled && theme2.items.item.disabled), onClick: () => {
      if (isDisabled)
        return;
...
var DatepickerViewsDecades = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime21.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_year, index3) => {
...
var useTheme = () => {
  return (0, import_react14.useContext)(ThemeContext);
};
...
var useThemeMode = () => {
  ...
  const setModeOnBody = (0, import_react14.useCallback)((mode2) => {
    if (!isClient()) {
      return;
    }
    if (mode2 === "dark") {
  ...
  const { mode: initialMode, toggleMode = onToggleMode } = (0, import_react14.useContext)(ThemeContext);
...
var Flowbite = ({ children, theme: theme2 = {} }) => {
  ...
  const themeContextValue = (0, import_react15.useMemo)(() => ({
    theme: mergedTheme,
    mode,
    toggleMode
  }), [mode, toggleMode, mergedTheme]);
  return (0, import_jsx_runtime23.jsx)(ThemeContext.Provider, { value: themeContextValue, children });
};
...
var DatepickerViewsMonth = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime24.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_month, index3) => {
...
var Datepicker = ({
  ...
  const renderView = (type) => {
    switch (type) {
      case Views.Decades:
        return (0, import_jsx_runtime26.jsx)(DatepickerViewsDecades, { theme: theme2.views.decades });
      case Views.Years:
        return (0, import_jsx_runtime26.jsx)(DatepickerViewsYears, { theme: theme2.views.years });
      case Views.Months:
        return (0, import_jsx_runtime26.jsx)(DatepickerViewsMonth, { theme: theme2.views.months });
      case Views.Days:
      default:
        return (0, import_jsx_runtime26.jsx)(DatepickerViewsDays, { theme: theme2.views.days });
    }
  };
  const getNextView = () => {
    switch (view) {
  ...
  return (0, import_jsx_runtime26.jsx)(DatepickerContext.Provider, { value: {
    language,
    minDate,
    maxDate,
    weekStart,
    ...
    setSelectedDate,
    changeSelectedDate
  }, children: (0, import_jsx_runtime26.jsxs)("div", { className: twMerge(theme2.root.base, className), children: [!inline2 && (0, import_jsx_runtime26.jsx)(TextInput, { theme: theme2.root.input, icon: HiCalendar, ref: inputRef, onFocus: () => {
    if (!isDateEqual(viewDate, selectedDate)) {
      setViewDate(selectedDate);
    }
    setIsOpen(true);
  }, value: selectedDate && getFormattedDate(language, selectedDate), readOnly: true, ...props }), (isOpen || inline2) && (0, import_jsx_runtime26.jsx)("div", { ref: datepickerRef, className: twMerge(theme2.popup.root.base, inline2 && theme2.popup.root.inline), children: (0, import_jsx_runtime26.jsxs)("div", { className: theme2.popup.root.inner, children: [(0, import_jsx_runtime26.jsxs)("div", { className: theme2.popup.header.base, children: [title && (0, import_jsx_runtime26.jsx)("div", { className: theme2.popup.header.title, children: title }), (0, import_jsx_runtime26.jsxs)("div", { className: theme2.popup.header.selectors.base, children: [(0, import_jsx_runtime26.jsx)("button", { type: "button", className: twMerge(theme2.popup.header.selectors.button.base, theme2.popup.header.selectors.button.prev), onClick: () => setViewDate(getViewDatePage(view, viewDate, -1)), children: (0, import_jsx_runtime26.jsx)(HiArrowLeft, {}) }), (0, import_jsx_runtime26.jsx)("button", { type: "button", className: twMerge(theme2.popup.header.selectors.button.base, theme2.popup.header.selectors.button.view), onClick: () => setView(getNextView()), children: getViewTitle() }), (0, import_jsx_runtime26.jsx)("button", { type: "button", className: twMerge(theme2.popup.header.selectors.button.base, theme2.popup.header.selectors.button.next), onClick: () => setViewDate(getViewDatePage(view, viewDate, 1)), children: (0, import_jsx_runtime26.jsx)(HiArrowRight, {}) })] })] }), (0, import_jsx_runtime26.jsx)("div", { className: theme2.popup.view.base, children: renderView(view) }), (showClearButton || showTodayButton) && (0, import_jsx_runtime26.jsxs)("div", { className: theme2.popup.footer.base, children: [showTodayButton && (0, import_jsx_runtime26.jsx)("button", { type: "button", className: twMerge(theme2.popup.footer.button.base, theme2.popup.footer.button.today), onClick: () => {
    const today = /* @__PURE__ */ new Date();
    changeSelectedDate(today, true);
    setViewDate(today);
  }, children: labelTodayButton }), showClearButton && (0, import_jsx_runtime26.jsx)("button", { type: "button", className: twMerge(theme2.popup.footer.button.base, theme2.popup.footer.button.clear), onClick: () => {
...
var DropdownDivider = ({ className, ...props }) => {
  ...
  return (0, import_jsx_runtime27.jsx)("div", { className: twMerge(theme2, className), ...props });
};
...
var DropdownHeader = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [(0, import_jsx_runtime28.jsx)("div", { className: twMerge(theme2, className), ...props, children }), (0, import_jsx_runtime28.jsx)(DropdownDivider, {})] });
};
...
var DropdownItem = ({ children, className, icon: Icon, onClick, theme: customTheme = {}, ...props }) => {
  ...
  const { activeIndex, dismissOnClick, getItemProps, handleSelect } = (0, import_react20.useContext)(DropdownContext);
  const isActive = activeIndex === index3;
  const theme2 = mergeDeep(useTheme().theme.dropdown.floating.item, customTheme);
  const theirProps = props;
  return (0, import_jsx_runtime29.jsx)("li", { role: "menuitem", className: theme2.container, children: (0, import_jsx_runtime29.jsxs)(ButtonBase, { ref, className: twMerge(theme2.base, className), ...theirProps, ...getItemProps({
    onClick: () => {
      onClick && onClick();
      dismissOnClick && handleSelect(null);
    }
  }), tabIndex: isActive ? 0 : -1, children: [Icon && (0, import_jsx_runtime29.jsx)(Icon, { className: theme2.icon }), children] }) });
};
...
var Trigger = ({ refs, children, inline: inline2, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  return inline2 ? (0, import_jsx_runtime30.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime30.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
var DropdownContext = (0, import_react24.createContext)({});
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, renderTrigger, ...props }) => {
  ...
  return (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [(0, import_jsx_runtime30.jsxs)(Trigger, { ...buttonProps, refs, inline: inline2, theme: theme2, "data-testid": dataTestId, className: twMerge(theme2.floating.target, buttonProps.className), setButtonWidth, getReferenceProps, renderTrigger, children: [label, arrowIcon && (0, import_jsx_runtime30.jsx)(Icon, { className: theme2.arrowIcon })] }), (0, import_jsx_runtime30.jsx)(DropdownContext.Provider, { value: {
    activeIndex,
    dismissOnClick,
    getItemProps,
    handleSelect
  }, children: open && (0, import_jsx_runtime30.jsx)(FloatingFocusManager, { context, modal: false, children: (0, import_jsx_runtime30.jsx)("div", { ref: refs.setFloating, style: { ...floatingStyles, minWidth: buttonWidth }, "data-testid": "flowbite-dropdown", "aria-expanded": open, ...getFloatingProps({
  ...
  }), children: (0, import_jsx_runtime30.jsx)(FloatingList, { elementsRef, labelsRef, children: (0, import_jsx_runtime30.jsx)("ul", { className: theme2.content, tabIndex: -1, children }) }) }) }) })] });
};
...
var FileInput = (0, import_react25.forwardRef)(({ className, color = "gray", helperText, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime31.jsxs)(import_jsx_runtime31.Fragment, { children: [(0, import_jsx_runtime31.jsx)("div", { className: twMerge(theme2.root.base, className), children: (0, import_jsx_runtime31.jsx)("div", { className: theme2.field.base, children: (0, import_jsx_runtime31.jsx)("input", { className: twMerge(theme2.field.input.base, theme2.field.input.colors[color], theme2.field.input.sizes[sizing]), ...props, type: "file", ref }) }) }), helperText && (0, import_jsx_runtime31.jsx)(HelperText, { color, children: helperText })] });
});
...
var FooterBrand = ({ alt, className, children, href, name, src, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime32.jsx)("div", { children: href ? (0, import_jsx_runtime32.jsxs)("a", { "data-testid": "flowbite-footer-brand", href, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime32.jsx)("img", { alt, src, className: theme2.img }), (0, import_jsx_runtime32.jsx)("span", { "data-testid": "flowbite-footer-brand-span", className: theme2.span, children: name }), children] }) : (0, import_jsx_runtime32.jsx)("img", { alt, "data-testid": "flowbite-footer-brand", src, className: twMerge(theme2.img, className), ...props }) });
};
...
var FooterCopyright = ({ by, className, href, theme: customTheme = {}, year, ...props }) => {
  ...
  return (0, import_jsx_runtime33.jsxs)("div", { "data-testid": "flowbite-footer-copyright", className: twMerge(theme2.base, className), ...props, children: ["© ", year, href ? (0, import_jsx_runtime33.jsx)("a", { href, className: theme2.href, children: by }) : (0, import_jsx_runtime33.jsx)("span", { "data-testid": "flowbite-footer-copyright-span", className: theme2.span, children: by })] });
};
...
var FooterDivider = ({ className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime34.jsx)("hr", { "data-testid": "footer-divider", className: twMerge(theme2.base, className), ...props });
};
...
var FooterIcon = ({ ariaLabel, className, href, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime35.jsx)("div", { children: href ? (0, import_jsx_runtime35.jsx)("a", { "aria-label": ariaLabel, "data-testid": "flowbite-footer-icon", href, className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime35.jsx)(Icon, { className: theme2.size }) }) : (0, import_jsx_runtime35.jsx)(Icon, { "data-testid": "flowbite-footer-icon", className: theme2.size, ...props }) });
};
...
var FooterLink = ({ as: Component = "a", children, className, href, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime36.jsx)("li", { className: twMerge(theme2.base, className), children: (0, import_jsx_runtime36.jsx)(Component, { href, className: theme2.href, ...props, children }) });
};
...
var FooterLinkGroup = ({ children, className, col = false, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime37.jsx)("ul", { "data-testid": "footer-groupLink", className: twMerge(theme2.base, col && theme2.col, className), ...props, children });
};
...
var FooterTitle = ({ as: Component = "h2", className, theme: customTheme = {}, title, ...props }) => {
  ...
  return (0, import_jsx_runtime38.jsx)(Component, { "data-testid": "flowbite-footer-title", className: twMerge(theme2.base, className), ...props, children: title });
};
...
var FooterComponent = ({ bgDark = false, children, className, container = false, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime39.jsx)("footer", { "data-testid": "flowbite-footer", className: twMerge(theme2.root.base, bgDark && theme2.root.bgDark, container && theme2.root.container, className), ...props, children });
};
...
var HelperText = ({ children, className, color = "default", theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime40.jsx)("p", { className: twMerge(theme2.root.base, theme2.root.colors[color], className), ...props, children: value ?? children ?? "" });
};
...
var Kbd = ({ children, className, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime41.jsxs)("span", { className: twMerge(theme2.root.base, className), "data-testid": "flowbite-kbd", ...props, children: [Icon && (0, import_jsx_runtime41.jsx)(Icon, { className: theme2.root.icon, "data-testid": "flowbite-kbd-icon" }), children] });
};
Kbd.displayName = "Kbd";
...
var Label = ({ children, className, color = "default", disabled = false, theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime42.jsx)("label", { className: twMerge(theme2.root.base, theme2.root.colors[color], disabled && theme2.root.disabled, className), "data-testid": "flowbite-label", ...props, children: value ?? children ?? "" });
};
...
var ListGroupItem = ({ active: isActive, children, className, href, icon: Icon, onClick, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime43.jsx)("li", { className: twMerge(theme2.base, className), children: (0, import_jsx_runtime43.jsxs)(Component, { href, onClick, type: isLink ? void 0 : "button", className: twMerge(theme2.link.active[isActive ? "on" : "off"], theme2.link.base, theme2.link.href[isLink ? "on" : "off"]), ...props, children: [Icon && (0, import_jsx_runtime43.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-list-group-item-icon", className: theme2.link.icon }), children] }) });
};
...
var ListGroupComponent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime44.jsx)("ul", { className: twMerge(theme2.root.base, className), ...props, children });
};
...
var ModalBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime45.jsx)("div", { className: twMerge(theme2.base, popup && [theme2.popup], className), ...props, children });
};
...
var ModalHeader = ({ as: Component = "h3", children, className, theme: customTheme = {}, id, ...props }) => {
  ...
  return (0, import_jsx_runtime47.jsxs)("div", { className: twMerge(theme2.base, popup && theme2.popup, className), ...props, children: [(0, import_jsx_runtime47.jsx)(Component, { id: headerId, className: theme2.title, children }), (0, import_jsx_runtime47.jsx)("button", { "aria-label": "Close", className: theme2.close.base, type: "button", onClick: onClose, children: (0, import_jsx_runtime47.jsx)(HiOutlineX, { "aria-hidden": true, className: theme2.close.icon }) })] });
};
...
var ModalComponent = (0, import_react29.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size2 = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
  ...
  return (0, import_jsx_runtime48.jsx)(ModalContext.Provider, { value: { popup, onClose, setHeaderId }, children: (0, import_jsx_runtime48.jsx)(FloatingPortal, { root, children: (0, import_jsx_runtime48.jsx)(FloatingOverlay, { lockScroll: true, "data-testid": "modal-overlay", className: twMerge(theme2.root.base, theme2.root.positions[position], show ? theme2.root.show.on : theme2.root.show.off, className), ...props, children: (0, import_jsx_runtime48.jsx)(FloatingFocusManager, { context, initialFocus, children: (0, import_jsx_runtime48.jsx)("div", { ref, ...getFloatingProps(props), "aria-labelledby": headerId, className: twMerge(theme2.content.base, theme2.root.sizes[size2]), children: (0, import_jsx_runtime48.jsx)("div", { className: theme2.content.inner, children }) }) }) }) }) });
});
...
var NavbarBrand = ({ as: Component = "a", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime49.jsx)(Component, { className: twMerge(theme2.base, className), ...props, children });
};
...
var NavbarCollapse = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime50.jsx)("div", { "data-testid": "flowbite-navbar-collapse", className: twMerge(theme2.base, theme2.hidden[!isOpen ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime50.jsx)("ul", { className: theme2.list, children }) });
};
...
var NavbarLink = ({ active, as: Component = "a", disabled, children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime51.jsx)("li", { children: (0, import_jsx_runtime51.jsx)(Component, { className: twMerge(theme2.base, active && theme2.active.on, !active && !disabled && theme2.active.off, theme2.disabled[disabled ? "on" : "off"], className), ...props, children }) });
};
...
var NavbarToggle = ({ barIcon: BarIcon = FaBars, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime52.jsxs)("button", { "data-testid": "flowbite-navbar-toggle", onClick: handleClick, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime52.jsx)("span", { className: "sr-only", children: "Open main menu" }), (0, import_jsx_runtime52.jsx)(BarIcon, { "aria-hidden": true, className: theme2.icon })] });
};
...
var NavbarComponent = ({ border, children, className, fluid = false, menuOpen, rounded, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime53.jsx)(NavbarContext.Provider, { value: { isOpen, setIsOpen }, children: (0, import_jsx_runtime53.jsx)("nav", { className: twMerge(theme2.base, theme2.bordered[border ? "on" : "off"], theme2.rounded[rounded ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime53.jsx)("div", { className: twMerge(theme2.inner.base, theme2.inner.fluid[fluid ? "on" : "off"]), children }) }) });
};
...
var PaginationButton = ({ active, children, className, onClick, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime54.jsx)("button", { type: "button", className: twMerge(active && theme2.pages.selector.active, className), onClick, ...props, children });
};
PaginationButton.displayName = "Pagination.Button";
var PaginationNavigation = ({ children, className, onClick, theme: customTheme = {}, disabled = false, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.pagination, customTheme);
  return (0, import_jsx_runtime54.jsx)("button", { type: "button", className: twMerge(disabled && theme2.pages.selector.disabled, className), disabled, onClick, ...props, children });
};
...
// node_modules/flowbite-react/lib/esm/components/Pagination/Pagination.js
var PaginationComponent = ({ className, currentPage, layout = "pagination", nextLabel = "Next", onPageChange, previousLabel = "Previous", renderPaginationButton = (props2) => (0, import_jsx_runtime55.jsx)(PaginationButton, { ...props2 }), showIcons: showIcon = false, theme: customTheme = {}, totalPages, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.pagination, customTheme);
  ...
  return (0, import_jsx_runtime55.jsxs)("nav", { className: twMerge(theme2.base, className), ...props, children: [layout === "table" && (0, import_jsx_runtime55.jsxs)("div", { className: theme2.layout.table.base, children: ["Showing ", (0, import_jsx_runtime55.jsx)("span", { className: theme2.layout.table.span, children: firstPage }), " to ", (0, import_jsx_runtime55.jsx)("span", { className: theme2.layout.table.span, children: lastPage }), " of ", (0, import_jsx_runtime55.jsx)("span", { className: theme2.layout.table.span, children: totalPages }), " Entries"] }), (0, import_jsx_runtime55.jsxs)("ul", { className: theme2.pages.base, children: [(0, import_jsx_runtime55.jsx)("li", { children: (0, import_jsx_runtime55.jsxs)(PaginationNavigation, { className: twMerge(theme2.pages.previous.base, showIcon && theme2.pages.showIcon), onClick: goToPreviousPage, disabled: currentPage === 1, children: [showIcon && (0, import_jsx_runtime55.jsx)(HiChevronLeft, { "aria-hidden": true, className: theme2.pages.previous.icon }), previousLabel] }) }), layout === "pagination" && range(firstPage, lastPage).map((page) => (0, import_jsx_runtime55.jsx)("li", { "aria-current": page === currentPage ? "page" : void 0, children: renderPaginationButton({
    className: twMerge(theme2.pages.selector.base, currentPage === page && theme2.pages.selector.active),
    active: page === currentPage,
    onClick: () => onPageChange(page),
    children: page
  }) }, page)), (0, import_jsx_runtime55.jsx)("li", { children: (0, import_jsx_runtime55.jsxs)(PaginationNavigation, { className: twMerge(theme2.pages.next.base, showIcon && theme2.pages.showIcon), onClick: goToNextPage, disabled: currentPage === totalPages, children: [nextLabel, showIcon && (0, import_jsx_runtime55.jsx)(HiChevronRight, { "aria-hidden": true, className: theme2.pages.next.icon })] }) })] })] });
};
...
var Progress = ({ className, color = "blue", labelProgress = false, labelText = false, progress, progressLabelPosition = "inside", size: size2 = "md", textLabel = "progressbar", textLabelPosition = "inside", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime56.jsx)(import_jsx_runtime56.Fragment, { children: (0, import_jsx_runtime56.jsxs)("div", { id, "aria-label": textLabel, "aria-valuenow": progress, role: "progressbar", ...props, children: [(textLabel && labelText && textLabelPosition === "outside" || progress > 0 && labelProgress && progressLabelPosition === "outside") && (0, import_jsx_runtime56.jsxs)("div", { className: theme2.label, "data-testid": "flowbite-progress-outer-label-container", children: [textLabel && labelText && textLabelPosition === "outside" && (0, import_jsx_runtime56.jsx)("span", { "data-testid": "flowbite-progress-outer-text-label", children: textLabel }), labelProgress && progressLabelPosition === "outside" && (0, import_jsx_runtime56.jsxs)("span", { "data-testid": "flowbite-progress-outer-progress-label", children: [progress, "%"] })] }), (0, import_jsx_runtime56.jsx)("div", { className: twMerge(theme2.base, theme2.size[size2], className), children: (0, import_jsx_runtime56.jsxs)("div", { style: { width: `${progress}%` }, className: twMerge(theme2.bar, theme2.color[color], theme2.size[size2]), children: [textLabel && labelText && textLabelPosition === "inside" && (0, import_jsx_runtime56.jsx)("span", { "data-testid": "flowbite-progress-inner-text-label", children: textLabel }), progress > 0 && labelProgress && progressLabelPosition === "inside" && (0, import_jsx_runtime56.jsxs)("span", { "data-testid": "flowbite-progress-inner-progress-label", children: [progress, "%"] })] }) })] }) });
};
...
var Radio = (0, import_react33.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime57.jsx)("input", { ref, type: "radio", className: twMerge(theme2.root.base, className), ...props });
});
...
var RangeSlider = (0, import_react34.forwardRef)(({ className, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime58.jsx)(import_jsx_runtime58.Fragment, { children: (0, import_jsx_runtime58.jsx)("div", { "data-testid": "flowbite-range-slider", className: twMerge(theme2.root.base, className), children: (0, import_jsx_runtime58.jsx)("div", { className: theme2.field.base, children: (0, import_jsx_runtime58.jsx)("input", { ref, type: "range", className: twMerge(theme2.field.input.base, theme2.field.input.sizes[sizing]), ...props }) }) }) });
});
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime60.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size2], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size2 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime61.jsx)(RatingContext.Provider, { value: { size: size2 }, children: (0, import_jsx_runtime61.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var Select = (0, import_react36.forwardRef)(({ addon, children, className, color = "gray", helperText, icon: Icon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime62.jsxs)("div", { className: twMerge(theme2.base, className), children: [addon && (0, import_jsx_runtime62.jsx)("span", { className: theme2.addon, children: addon }), (0, import_jsx_runtime62.jsxs)("div", { className: theme2.field.base, children: [Icon && (0, import_jsx_runtime62.jsx)("div", { className: theme2.field.icon.base, children: (0, import_jsx_runtime62.jsx)(Icon, { className: theme2.field.icon.svg }) }), (0, import_jsx_runtime62.jsx)("select", { className: twMerge(theme2.field.select.base, theme2.field.select.colors[color], theme2.field.select.sizes[sizing], theme2.field.select.withIcon[Icon ? "on" : "off"], theme2.field.select.withAddon[addon ? "on" : "off"], theme2.field.select.withShadow[shadow ? "on" : "off"]), ...props, ref, children }), helperText && (0, import_jsx_runtime62.jsx)(HelperText, { color, children: helperText })] })] });
});
...
var SidebarCTA = ({ children, color = "info", className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime63.jsx)("div", { "data-testid": "sidebar-cta", hidden: isCollapsed, className: twMerge(theme2.base, theme2.color[color], className), ...props, children });
};
...
var SidebarItemContext = (0, import_react38.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react38.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({ children, className, icon: Icon, label, chevronIcon: ChevronIcon = HiChevronDown, renderChevronIcon, open = false, theme: customTheme = {}, ...props }) => {
  ...
  const { isCollapsed } = useSidebarContext();
  const [isOpen, setOpen] = (0, import_react39.useState)(open);
  const theme2 = mergeDeep(useTheme().theme.sidebar.collapse, customTheme);
  (0, import_react39.useEffect)(() => setOpen(open), [open]);
  const Wrapper = ({ children: children2 }) => (0, import_jsx_runtime64.jsx)("li", { children: isCollapsed && !isOpen ? (0, import_jsx_runtime64.jsx)(Tooltip, { content: label, placement: "right", children: children2 }) : children2 });
  return (0, import_jsx_runtime64.jsxs)(Wrapper, { children: [(0, import_jsx_runtime64.jsxs)("button", { id: `flowbite-sidebar-collapse-${id}`, onClick: () => setOpen(!isOpen), title: label, type: "button", className: twMerge(theme2.button, className), ...props, children: [Icon && (0, import_jsx_runtime64.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-collapse-icon", className: twMerge(theme2.icon.base, theme2.icon.open[isOpen ? "on" : "off"]) }), isCollapsed ? (0, import_jsx_runtime64.jsx)("span", { className: "sr-only", children: label }) : (0, import_jsx_runtime64.jsxs)(import_jsx_runtime64.Fragment, { children: [(0, import_jsx_runtime64.jsx)("span", { "data-testid": "flowbite-sidebar-collapse-label", className: theme2.label.base, children: label }), renderChevronIcon ? renderChevronIcon(theme2, isOpen) : (0, import_jsx_runtime64.jsx)(ChevronIcon, { "aria-hidden": true, className: twMerge(theme2.label.icon.base, theme2.label.icon.open[isOpen ? "on" : "off"]) })] })] }), (0, import_jsx_runtime64.jsx)("ul", { "aria-labelledby": `flowbite-sidebar-collapse-${id}`, hidden: !isOpen, className: theme2.list, children: (0, import_jsx_runtime64.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: true }, children }) })] });
};
...
var ListItem = ({ id, isCollapsed, tooltipChildren, children: wrapperChildren, ...props }) => (0, import_jsx_runtime65.jsx)("li", { ...props, children: isCollapsed ? (0, import_jsx_runtime65.jsx)(Tooltip, { content: (0, import_jsx_runtime65.jsx)(TooltipContent, { id, children: tooltipChildren }), placement: "right", children: wrapperChildren }) : wrapperChildren });
var TooltipContent = ({ id, children }) => (0, import_jsx_runtime65.jsx)(Children4, { id, children });
var Children4 = ({ id, children }) => {
  const theme2 = useTheme().theme.sidebar.item;
  return (0, import_jsx_runtime65.jsx)("span", { "data-testid": "flowbite-sidebar-item-content", id: `flowbite-sidebar-item-${id}`, className: twMerge(theme2.content.base), children });
};
var SidebarItem = (0, import_react40.forwardRef)(({ active: isActive, as: Component = "a", children, className, icon: Icon, label, labelColor = "info", theme: customTheme = {}, ...props }, ref) => {
  var _a, _b, _c, _d;
  const id = (0, import_react40.useId)();
  const { isCollapsed } = useSidebarContext();
  const { isInsideCollapse } = useSidebarItemContext();
  const theme2 = mergeDeep(useTheme().theme.sidebar.item, customTheme);
  return (0, import_jsx_runtime65.jsx)(ListItem, { className: theme2.listItem, id, isCollapsed, tooltipChildren: children, children: (0, import_jsx_runtime65.jsxs)(Component, { "aria-labelledby": `flowbite-sidebar-item-${id}`, ref, className: twMerge(theme2.base, isActive && theme2.active, !isCollapsed && isInsideCollapse && ((_a = theme2.collapsed) == null ? void 0 : _a.insideCollapse), className), ...props, children: [Icon && (0, import_jsx_runtime65.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-item-icon", className: twMerge((_b = theme2.icon) == null ? void 0 : _b.base, isActive && ((_c = theme2.icon) == null ? void 0 : _c.active)) }), isCollapsed && !Icon && (0, import_jsx_runtime65.jsx)("span", { className: (_d = theme2.collapsed) == null ? void 0 : _d.noIcon, children: children.charAt(0).toLocaleUpperCase() ?? "?" }), !isCollapsed && (0, import_jsx_runtime65.jsx)(Children4, { id, children }), !isCollapsed && label && (0, import_jsx_runtime65.jsx)(Badge, { color: labelColor, "data-testid": "flowbite-sidebar-label", hidden: isCollapsed, className: theme2.label, children: label })] }) });
});
...
var SidebarItemGroup = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime66.jsx)("ul", { "data-testid": "flowbite-sidebar-item-group", className: twMerge(theme2, className), ...props, children: (0, import_jsx_runtime66.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: false }, children }) });
};
...
var SidebarItems = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime67.jsx)("div", { className: twMerge(theme2, className), "data-testid": "flowbite-sidebar-items", ...props, children });
};
...
var SidebarLogo = ({ children, className, href, img, imgAlt = "", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime68.jsxs)("a", { "aria-labelledby": `flowbite-sidebar-logo-${id}`, href, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime68.jsx)("img", { alt: imgAlt, src: img, className: theme2.img }), (0, import_jsx_runtime68.jsx)("span", { className: theme2.collapsed[isCollapsed ? "on" : "off"], id: `flowbite-sidebar-logo-${id}`, children })] });
};
...
var SidebarComponent = ({ children, as: Component = "nav", collapseBehavior = "collapse", collapsed: isCollapsed = false, theme: customTheme = {}, className, ...props }) => {
  ...
  return (0, import_jsx_runtime69.jsx)(SidebarContext.Provider, { value: { isCollapsed }, children: (0, import_jsx_runtime69.jsx)(Component, { "aria-label": "Sidebar", hidden: isCollapsed && collapseBehavior === "hide", className: twMerge(theme2.root.base, theme2.root.collapsed[isCollapsed ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime69.jsx)("div", { className: theme2.root.inner, children }) }) });
};
...
var Spinner = ({ className, color = "info", light, size: size2 = "md", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime70.jsx)("span", { role: "status", ...props, children: (0, import_jsx_runtime70.jsxs)("svg", { fill: "none", viewBox: "0 0 100 101", className: twMerge(theme2.base, theme2.color[color], theme2.light[light ? "on" : "off"].base, theme2.light[light ? "on" : "off"].color[color], theme2.size[size2], className), children: [(0, import_jsx_runtime70.jsx)("path", { d: "M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z", fill: "currentColor" }), (0, import_jsx_runtime70.jsx)("path", { d: "M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z", fill: "currentFill" })] }) });
};
...
var TabItem = ({ children, className }) => (0, import_jsx_runtime71.jsx)("div", { className, children });
...
var TabsComponent = (0, import_react42.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  ...
  const tabs = (0, import_react42.useMemo)(() => import_react42.Children.map(children, ({ props: props2 }) => props2), [children]);
  ...
  return (0, import_jsx_runtime72.jsxs)("div", { className: twMerge(theme2.base, className), children: [(0, import_jsx_runtime72.jsx)("div", { "aria-label": "Tabs", role: "tablist", className: twMerge(theme2.tablist.base, theme2.tablist.styles[style], className), ...props, children: tabs.map((tab, index3) => (0, import_jsx_runtime72.jsxs)("button", { type: "button", "aria-controls": `${id}-tabpanel-${index3}`, "aria-selected": index3 === activeTab, className: twMerge(theme2.tablist.tabitem.base, tabItemStyle.base, index3 === activeTab && tabItemStyle.active.on, index3 !== activeTab && !tab.disabled && tabItemStyle.active.off), disabled: tab.disabled, id: `${id}-tab-${index3}`, onClick: () => handleClick({ target: index3 }), onKeyDown: (event) => handleKeyboard({ event, target: index3 }), ref: (element) => tabRefs.current[index3] = element, role: "tab", tabIndex: index3 === focusedTab ? 0 : -1, style: { zIndex: index3 === focusedTab ? 2 : 1 }, children: [tab.icon && (0, import_jsx_runtime72.jsx)(tab.icon, { className: theme2.tablist.tabitem.icon }), tab.title] }, index3)) }), (0, import_jsx_runtime72.jsx)("div", { className: twMerge(theme2.tabitemcontainer.base, tabItemContainerStyle), children: tabs.map((tab, index3) => (0, import_jsx_runtime72.jsx)("div", { "aria-labelledby": `${id}-tab-${index3}`, className: theme2.tabpanel, hidden: index3 !== activeTab, id: `${id}-tabpanel-${index3}`, role: "tabpanel", tabIndex: 0, children: tab.children }, index3)) })] });
});
...
var TableBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime73.jsx)("tbody", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime74.jsx)("td", { className: twMerge(theme2.base, className), ...props, children });
};

// node_modules/flowbite-react/lib/esm/components/Table/TableContext.js
var import_react43 = __toESM(require_react());
var TableContext = (0, import_react43.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react43.useContext)(TableContext);
  if (!context) {
...
var TableHead = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime75.jsx)("thead", { className: twMerge(theme2.head.base, className), ...props, children: (0, import_jsx_runtime75.jsx)("tr", { children }) });
};
...
var TableHeadCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime76.jsx)("th", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TableRow = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime77.jsx)("tr", { "data-testid": "table-row-element", className: twMerge(theme2.base, striped && theme2.striped, hoverable && theme2.hovered, className), ...props, children });
};

// node_modules/flowbite-react/lib/esm/components/Table/Table.js
var TableComponent = ({ children, className, hoverable, striped, theme: customTheme = {}, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.table, customTheme);
  return (0, import_jsx_runtime78.jsx)("div", { "data-testid": "table-element", className: twMerge(theme2.root.wrapper), children: (0, import_jsx_runtime78.jsxs)(TableContext.Provider, { value: { striped, hoverable }, children: [(0, import_jsx_runtime78.jsx)("div", { className: twMerge(theme2.root.shadow, className) }), (0, import_jsx_runtime78.jsx)("table", { className: twMerge(theme2.root.base, className), ...props, children })] }) });
};
...
var TextInput = (0, import_react44.forwardRef)(({ addon, className, color = "gray", helperText, icon: Icon, rightIcon: RightIcon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.textInput, customTheme);
  return (0, import_jsx_runtime79.jsxs)(import_jsx_runtime79.Fragment, { children: [(0, import_jsx_runtime79.jsxs)("div", { className: twMerge(theme2.base, className), children: [addon && (0, import_jsx_runtime79.jsx)("span", { className: theme2.addon, children: addon }), (0, import_jsx_runtime79.jsxs)("div", { className: theme2.field.base, children: [Icon && (0, import_jsx_runtime79.jsx)("div", { className: theme2.field.icon.base, children: (0, import_jsx_runtime79.jsx)(Icon, { className: theme2.field.icon.svg }) }), RightIcon && (0, import_jsx_runtime79.jsx)("div", { "data-testid": "right-icon", className: theme2.field.rightIcon.base, children: (0, import_jsx_runtime79.jsx)(RightIcon, { className: theme2.field.rightIcon.svg }) }), (0, import_jsx_runtime79.jsx)("input", { className: twMerge(theme2.field.input.base, theme2.field.input.colors[color], theme2.field.input.sizes[sizing], theme2.field.input.withIcon[Icon ? "on" : "off"], theme2.field.input.withRightIcon[RightIcon ? "on" : "off"], theme2.field.input.withAddon[addon ? "on" : "off"], theme2.field.input.withShadow[shadow ? "on" : "off"]), ...props, ref })] })] }), helperText && (0, import_jsx_runtime79.jsx)(HelperText, { color, children: helperText })] });
});
...
var Textarea = (0, import_react45.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.textarea, customTheme);
  return (0, import_jsx_runtime80.jsxs)(import_jsx_runtime80.Fragment, { children: [(0, import_jsx_runtime80.jsx)("textarea", { ref, className: twMerge(theme2.base, theme2.colors[color], theme2.withShadow[shadow ? "on" : "off"], className), ...props }), helperText && (0, import_jsx_runtime80.jsx)(HelperText, { color, children: helperText })] });
});
...
var TimelineBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime81.jsx)("div", { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineContext = (0, import_react46.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react46.useContext)(TimelineContext);
  if (!context) {
...
var TimelineContent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime82.jsx)("div", { "data-testid": "timeline-content", className: twMerge(horizontal && theme2.root.base, className), ...props, children });
};
...
var TimelineItem = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime83.jsx)("li", { "data-testid": "timeline-item", className: twMerge(horizontal && theme2.root.horizontal, !horizontal && theme2.root.vertical, className), ...props, children });
};
...
var TimelinePoint = ({ children, className, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime84.jsxs)("div", { "data-testid": "timeline-point", className: twMerge(horizontal && theme2.horizontal, !horizontal && theme2.vertical, className), ...props, children: [children, Icon ? (0, import_jsx_runtime84.jsx)("span", { className: twMerge(theme2.marker.icon.wrapper), children: (0, import_jsx_runtime84.jsx)(Icon, { "aria-hidden": true, className: twMerge(theme2.marker.icon.base) }) }) : (0, import_jsx_runtime84.jsx)("div", { className: twMerge(horizontal && theme2.marker.base.horizontal, !horizontal && theme2.marker.base.vertical) }), horizontal && (0, import_jsx_runtime84.jsx)("div", { className: twMerge(theme2.line) })] });
};
...
var TimelineTime = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime85.jsx)("time", { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineTitle = ({ as: Tag = "h3", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime86.jsx)(Tag, { className: twMerge(theme2, className), ...props, children });
};
...
var TimelineComponent = ({ children, className, horizontal, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime87.jsx)(TimelineContext.Provider, { value: { horizontal }, children: (0, import_jsx_runtime87.jsx)("ol", { "data-testid": "timeline-component", className: twMerge(horizontal && theme2.root.direction.horizontal, !horizontal && theme2.root.direction.vertical, className), ...props, children }) });
};
...
var ToastToggle = ({ className, onClick, theme: customTheme = {}, xIcon: XIcon = HiX, onDismiss, ...props }) => {
  ...
  return (0, import_jsx_runtime88.jsx)("button", { "aria-label": "Close", onClick: handleClick, type: "button", className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime88.jsx)(XIcon, { "aria-hidden": true, className: theme2.icon }) });
};
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime89.jsx)(ToastContext.Provider, { value: { duration, isClosed, isRemoved, setIsClosed, setIsRemoved }, children: (0, import_jsx_runtime89.jsx)("div", { "data-testid": "flowbite-toast", role: "alert", className: twMerge(theme2.root.base, durationClasses[duration], isClosed && theme2.root.closed, className), ...props, children }) });
};
...
var Floating = ({ animation = "duration-300", arrow: arrow3 = true, children, className, content, placement = "top", style = "dark", theme: theme2, trigger = "hover", minWidth, ...props }) => {
  ...
  return (0, import_jsx_runtime91.jsxs)(import_jsx_runtime91.Fragment, { children: [(0, import_jsx_runtime91.jsx)("div", { ref: refs.setReference, className: theme2.target, "data-testid": "flowbite-tooltip-target", ...getReferenceProps(), children }), (0, import_jsx_runtime91.jsxs)("div", { ref: refs.setFloating, "data-testid": "flowbite-tooltip", ...getFloatingProps({
...
var Tooltip = ({ animation = "duration-300", arrow: arrow3 = true, children, className, content, placement = "top", style = "dark", theme: customTheme = {}, trigger = "hover", ...props }) => {
  ...
  return (0, import_jsx_runtime92.jsx)(Floating, { animation, arrow: arrow3, content, placement, style, theme: theme2, trigger, className, ...props, children });
};
